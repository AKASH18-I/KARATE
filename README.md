Notes: Karate Club Modularity Assignment

This repository contains code to perform recursive spectral modularity partitioning on Zachary's Karate Club graph.

Files of interest:
- `DSC212_Assignment_AkashItkalwar_fixed.ipynb` — Repaired notebook (run interactively in Jupyter/VS Code).
...
If you prefer to open the notebook and rurunnteractively, open `DSC212_Assignment_HarshSuthar_fixed.ipynb` in VS Code or Jupyter and run all cells.
